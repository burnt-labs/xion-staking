...
export const external = [
  ...
  '<path d="M6.66666 9.33333L14 2" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>',
  "</svg>",
].join("");
...
export const trash = [
  ...
  '<g id="Trash 2">',
  '<path id="Icon" d="M13 15.3333H14.6667M14.6667 15.3333H28M14.6667 15.3333L14.6667 27C14.6667 27.442 14.8423 27.866 15.1548 28.1785C15.4674 28.4911 15.8913 28.6667 16.3333 28.6667H24.6667C25.1087 28.6667 25.5326 28.4911 25.8452 28.1785C26.1577 27.866 26.3333 27.442 26.3333 27V15.3333M17.1667 15.3333V13.6667C17.1667 13.2246 17.3423 12.8007 17.6548 12.4882C17.9674 12.1756 18.3913 12 18.8333 12H22.1667C22.6087 12 23.0326 12.1756 23.3452 12.4882C23.6577 12.8007 23.8333 13.2246 23.8333 13.6667V15.3333M18.8333 19.5V24.5M22.1667 19.5V24.5" stroke="#D74506" stroke-linecap="round" stroke-linejoin="round"/>',
  "</g>",
  "</svg>",
].join("");
...
export const upload = [
  ...
  '<path d="M17.5 12.5V15.8333C17.5 16.2754 17.3244 16.6993 17.0118 17.0118C16.6993 17.3244 16.2754 17.5 15.8333 17.5H4.16667C3.72464 17.5 3.30072 17.3244 2.98816 17.0118C2.67559 16.6993 2.5 16.2754 2.5 15.8333V12.5M5.83333 7.5L10 3.33333M10 3.33333L14.1667 7.5M10 3.33333V12.5" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.67"/>',
  "</svg>",
].join("");
